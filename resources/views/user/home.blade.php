...
<body>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-6 py-3 wow fadeInUp">
            <h1 style="font-size:40px">Welcome to Pusat Kesihatan </h1>
            <h2 style="font-size: 30px">University Malaysia Pahang</h2>
            <br>
            <p class="text-grey mb-4">Emergency Services Policies<br>
                ...
                <br>
                Referral Services To Customer Hospital Policies<br>
                a) Students who require specialist doctor treatment, should get a reference letter from PKU's medical officer.<br>
          ...
          <div class="col-lg-6 wow fadeInRight" data-wow-delay="400ms">
            <div class="img-place custom-img-1">
                <img src="{{ asset('img/pku.JPG') }}" alt="iman" width="400" >
            </div>
          </div>
        </div>
      </div>
  ...
  <footer class="page-footer">
    <div class="container">
      ...
      <p id="copyright">Copyright &copy; 2020 <a href="https://macodeid.com/" target="_blank">Iman Jofaris</a>. All right reserved</p>
    </div>
  </footer>
